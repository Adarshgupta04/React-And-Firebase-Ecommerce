...
function Filter() {
    ...
    // Generate unique category and price options
        ...
        <div className='container mx-auto px-4 mt-5'>
            <div className="p-5 rounded-lg bg-gray-100 drop-shadow-xl border border-gray-200"
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button onClick={() => { setFilterType(''); setFilterPrice(''); }} className="px-4 py-2 bg-gray-50 hover:bg-gray-200 text-gray-800 text-sm font-medium rounded-md" style={{ color: mode === 'dark' ? 'white' : '' }}>
                        Reset Filter
                    </button>
                </div>
