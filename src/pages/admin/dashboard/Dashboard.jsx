...
function Dashboard() {
    ...
    const {product , order , user ,mode} = context
    
    // console.log("Dashboard : Products " , product.length);
    // console.log("Dashboard : Orders : " , order.length);
    // console.log("Dashboard : User : " , user.length);
