...
function Cart() {
  ...
  useEffect(() => {
    ...
    cartItems.forEach((cartItem) => {
      ...
      temp = temp + parseInt(cartItem.quantity * cartItem.price);
    })
    setTotalAmount(temp);
    // console.log(temp)
  }, [cartItems])
  ...
  const buyNow = async () => {
    ...
    console.log("address Ibfo");
    console.log(addressInfo)

    var options = {
      key: "rzp_test_du1sCe0mCEtPVQ",
      key_secret: "wH2avJ6boRkPR7VgVRGSCxfJ",
